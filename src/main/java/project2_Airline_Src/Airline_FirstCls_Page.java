...
public class Airline_FirstCls_Page {                                             // For TC6
	...
	//step- 2 - Create separate methods for each component to perform action
		...
		wait.withTimeout(Duration.ofSeconds(5));
			...
			wait.until(ExpectedConditions.visibilityOf(firstcls));
			firstcls.click();
		...
		public Airline_FirstCls_Page(WebDriver driver) {
