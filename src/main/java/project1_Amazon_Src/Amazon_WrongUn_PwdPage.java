...
public class Amazon_WrongUn_PwdPage                          //For TC3
{
	WebDriver driver;
  ...
  // step- 2 - Create separate methods for each component to perform action
	     ...
	     public void Un(String username2)
	     {
	    	 username.sendKeys(username2);                        //                                                                                                                                                                       ("8290654399");
	     }
	     ...
	     public void Pwd(String password2)
	     {
	    	 password.sendKeys(password2);                         //                                                                                                                                                                        ("Aj@803");
	     }
  ...
  // step- 3 - Initializing the elements using PageFactory class inside the constructor
	     ...
	     public Amazon_WrongUn_PwdPage(WebDriver driver)
	     {
	    	 //this.driver=driver;
