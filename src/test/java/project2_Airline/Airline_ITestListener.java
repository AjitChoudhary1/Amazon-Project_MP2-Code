...
public class Airline_ITestListener implements ITestListener {
  ...
  String date= f1.substring(8, 10);
	...
	File source = t1.getScreenshotAs(OutputType.FILE);
		File destination = new File("C:\\Users\\ajitc\\eclipse-workspace - new\\Maven_Projects_Programs\\ScreenShots AirlinePrj\\Airline Pass Sshot"
	...
	TakesScreenshot t1 = (TakesScreenshot) driver;
	File source = t1.getScreenshotAs(OutputType.FILE);
		File destination = new File("C:\\Users\\ajitc\\eclipse-workspace - new\\Maven_Projects_Programs\\ScreenShots AirlinePrj\\Airline Fail Sshot"
